...
The simulation builds its portfolio scenario directly from Python source; no binary
...
not be downloaded from an untrusted source.
...
constants now defined in `fire_building_sim/domain.py`; it is not a runtime input.
